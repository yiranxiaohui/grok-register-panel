...
- `cpa_auth_dir`
- `grok2api_auth_dir`
- 可选的 `grok2api_remote_url`、`grok2api_admin_username`、`grok2api_admin_password` 与 `grok2api_account_types`；面板登录远程 Grok2API 后分别调用 Build、Web、Console 账号导入 API，并以 `proxy_url` 携带该账号注册全链路固定使用的代理
